...
const AdminDashboard = () => {
  ...
  return (
    <motion.div
      className="min-h-screen p-6 relative overflow-hidden text-black"
      variants={containerVariants}
      initial="hidden"
      animate="visible"
    >
      {/* Animated Background Elements */}
      {/* Animated Background Elements (kept, but background color/gradient removed) */}
        ...
        <div className="flex items-center justify-between">
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button
              ...
              className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-black px-6 py-3 rounded-xl shadow-lg"
            >
                ...
                >
                  <Button
                    ...
                    className={`min-w-40 h-12 rounded-xl border-2 transition-all duration-300 ${
                      balanceType.type === balanceType.type &&
                      balance?.data.currentBalance !== false
                        ? "bg-gradient-to-r from-purple-600 to-blue-600 text-black border-purple-500"
                        : "bg-white/10 hover:bg-white/20 border-white/20 hover:border-purple-300 text-black"
                    }`}
                  >
      ...
      <motion.div className="mb-8" variants={itemVariants}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                <div className="p-3 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl text-black">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                <div className="p-3 bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl text-black">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                <div className="p-3 bg-gradient-to-r from-purple-500 to-violet-600 rounded-xl text-black">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                <div className="p-3 bg-gradient-to-r from-orange-500 to-amber-600 rounded-xl text-black">
          ...
          {quickActions.map((action, index) => (
            ...
            >
              <div className="backdrop-blur-xl bg-white/10 rounded-2xl shadow-2xl border border-white/20 p-6 hover:shadow-xl transition-all duration-300 group-hover:border-white/40 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div
                    className={`p-3 rounded-xl mb-4 bg-gradient-to-r ${action.gradient} text-black`}
                  >
                    {action.icon}
                  </div>
                  <h3 className="font-semibold text-black mb-2 group-hover:text-purple-300 transition-colors">
                    {action.title}
                  </h3>
              ...
              {[
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-black/70">{activity.time}</p>
                  </div>
                </motion.div>
              ))}
            </div>
