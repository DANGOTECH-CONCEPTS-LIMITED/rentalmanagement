...
const SectionPanel = ({
  ...
  <div className="rounded-xl border border-[#E2E8F0] bg-slate-50/60 p-4">
    <div className="flex items-center gap-2 mb-4">
      <div
        className={`flex h-6 w-6 items-center justify-center rounded-md ${color}`}
      >
...
const PhotoUploadZone = ({
  ...
  <div className="grid grid-cols-3 gap-3">
    {photos.map((photo, i) => (
      <div
        key={i}
        className="relative h-28 overflow-hidden rounded-xl border border-[#E2E8F0]"
      >
        <img
          src={photo.preview}
          alt={`Photo ${i + 1}`}
    ...
    {photos.length < 3 && (
      <label className="flex h-28 cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-[#E2E8F0] bg-white hover:border-[#1D4ED8] hover:bg-blue-50/30 transition-colors">
        ...
        <p className="text-center text-[11px] text-[#94A3B8]">
          <span className="font-semibold text-[#1D4ED8]">Upload</span>
          <br />
          PNG / JPG
        </p>
        <input
    ...
    {photos.length === 0 && (
      <div className="col-span-2 flex items-center">
        <p className="text-xs text-[#94A3B8]">
          Upload up to 3 photos. First photo will be the cover image.
        </p>
      </div>
    )}
  </div>
...
const Properties = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: (error as any)?.message ?? "Failed to register property.",
        variant: "destructive",
      });
    } finally {
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4 backdrop-blur-sm">
            ...
            >
              ...
              <div className="bg-gradient-to-br from-[#0f2044] to-[#1D4ED8] shrink-0 px-6 pt-5 pb-8 text-white">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/15 hover:bg-white/25 transition-colors"
              ...
              <div className="mx-5 -mt-4 shrink-0 rounded-xl bg-white border border-slate-200 shadow-md px-4 py-3 flex items-center gap-3 z-10">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm font-bold text-[#0F172A] truncate">
                    {selectedProperty.district}, {selectedProperty.region}
                  </p>
                </div>
                <span
              ...
              <div className="flex items-center gap-2 shrink-0 border-t border-slate-100 px-5 py-4">
                ...
                <button
                  className="flex-1 inline-flex items-center justify-center gap-1.5 rounded-xl border border-emerald-200 bg-emerald-50 py-2.5 text-sm font-semibold text-emerald-700 hover:bg-emerald-100 transition-colors"
                  onClick={() => {
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-blue-200/70">
                    Fill in the details to register a property
                  </p>
                </div>
              </div>
              <button
            ...
            <form onSubmit={handleSubmit} className="overflow-y-auto flex-1">
                          ...
                          <ul className="absolute z-20 w-full mt-1 bg-white border border-[#E2E8F0] rounded-xl shadow-lg max-h-48 overflow-y-auto">
                            {filteredDistricts.map((d) => (
                              <li
                                ...
                                className="px-4 py-2.5 text-sm hover:bg-blue-50 hover:text-[#1D4ED8] cursor-pointer transition-colors"
                              >
                                {d}
                              </li>
                            ))}
              ...
              <div className="flex items-center justify-end gap-3 border-t border-[#E2E8F0] px-6 py-4 shrink-0">
                ...
                <button
                  ...
                  className="btn-grid inline-flex items-center gap-2 rounded-lg bg-[#1D4ED8] px-5 py-2 text-sm font-semibold text-white hover:bg-[#1e40af] disabled:opacity-60 transition-colors"
                >
            ...
            <div className="bg-gradient-to-r from-[#0F172A] to-[#1D4ED8] px-6 py-4 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-blue-200/70 truncate max-w-[240px]">
            ...
            >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleSelectChange("occupied", e.target.value)
                        }
                        className={selCls}
                      >
                        <option value="false">Vacant</option>
                      ...
                      <input
                        ...
                        value={
                          editingProperty.price
                            ? editingProperty.price.toLocaleString("en-US")
                            : ""
                        }
                        onChange={(e) => {
                          const d = e.target.value.replace(/[^0-9]/g, "");
                          setEditingProperty((p) =>
                            p ? { ...p, price: d ? Number(d) : 0 } : null,
                          );
                        }}
                ...
                >
                  ...
                  {propertyPhotos.length === 0 && editingProperty.imageUrl && (
                    <p className="mt-2 text-xs text-[#94A3B8]">
                      Upload new photos only to replace the existing ones.
                    </p>
                  )}
                </SectionPanel>
              ...
              <div className="flex items-center justify-end gap-3 border-t border-[#E2E8F0] px-6 py-4 shrink-0">
                <button
                  ...
                  onClick={() => setEditingProperty(null)}
                  disabled={isSubmitting}
                  className="rounded-lg border border-[#E2E8F0] bg-white px-4 py-2 text-sm font-medium text-[#64748B] hover:bg-slate-50 disabled:opacity-60 transition-colors"
                >
                  Cancel
                </button>
                <button
