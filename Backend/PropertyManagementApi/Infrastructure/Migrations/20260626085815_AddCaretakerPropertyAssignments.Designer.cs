...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260626085815_AddCaretakerPropertyAssignments")]
    partial class AddCaretakerPropertyAssignments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.External.MpesaCallbackAudit", b =>
                {
                    ...
                    b.ToTable("MpesaCallbackAudits");
                });

            modelBuilder.Entity("Domain.Entities.External.VendorPayments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.PropertyMgt.CaretakerPropertyAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CaretakerId", "PropertyId")
                        .IsUnique();

                    b.ToTable("CaretakerPropertyAssignments");
                });
            ...
            modelBuilder.Entity("Domain.Entities.PropertyMgt.PropertyExpense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.PropertyMgt.PropertyTenant", b =>
                {
                    ...
                    b.Property<string>("ElectricityMeterNo")
                        .IsRequired()
                        .HasColumnType("longtext");
                    ...
                    b.Property<int?>("InvoiceGenerationDay")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NextOfKinIdNumber")
                        .IsRequired()
                        .HasColumnType("longtext");
                    ...
                    b.Property<string>("NextOfKinWorkplace")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("Domain.Entities.PropertyMgt.PropertyUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.PropertyMgt.RentalContract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.PropertyMgt.SmsLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.PropertyMgt.TenantInvoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.PropertyMgt.ViewingRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.PropertyMgt.CaretakerPropertyAssignment", b =>
                {
                    b.HasOne("Domain.Entities.PropertyMgt.User", "Caretaker")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.PropertyMgt.PropertyExpense", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.PropertyMgt.PropertyUnit", "Unit")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.PropertyMgt.RentalContract", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.PropertyMgt.PropertyTenant", "Tenant")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.PropertyMgt.TenantInvoice", b =>
                {
                    b.HasOne("Domain.Entities.PropertyMgt.User", "CreatedBy")
                        .WithMany()
