...
BEGIN
    ...
    CREATE TABLE `rentalcontracts` (
        ...
        CONSTRAINT `FK_rentalcontracts_LandLordProperties_PropertyId` FOREIGN KEY (`PropertyId`) REFERENCES `LandLordProperties` (`Id`),
        CONSTRAINT `FK_rentalcontracts_PropertyUnits_UnitId` FOREIGN KEY (`UnitId`) REFERENCES `PropertyUnits` (`Id`),
        CONSTRAINT `FK_rentalcontracts_Tenants_TenantId` FOREIGN KEY (`TenantId`) REFERENCES `Tenants` (`Id`),
